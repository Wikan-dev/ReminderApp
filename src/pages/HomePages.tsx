...
export default function HomePages() {
    return (
        <div className="bg-primary-2 h-screen flex flex-col justify-center p-5">
            ...
            <button className="w-full bg-primary-3 px-7.5 py-11 text-primary-1 flex items-center justify-between hover:bg-primary-4 transition-all duration-200 text-4xl font-jost rounded-cust mb-10">
                Get Started
